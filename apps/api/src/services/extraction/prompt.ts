...
Input:
"Call with Layla at Marina Estates. She's looking for a 2-bed near the marina, and wants to move in before the summer. She's also after a studio for her son, who's starting university. Her sister is looking for a place nearby too, she said. She also wants the floor plans sent over before Thursday. She did say the service charges on the last place we showed were too high. If the budget clears she'd take two units."

Output:
{"summary":"Layla at Marina Estates is looking for a 2-bed near the marina before summer and a studio for her son; her sister is also looking nearby; she flagged high service charges on the last property.","promises":[],"people":[{"name":"Layla","role":null,"reports_to":null,"decision_role":"unknown","notes":"Contact at Marina Estates"}],"personal_facts":[],"key_dates":[],"concerns":["Service charges on the last property shown were too high"],"next_steps":["Send the floor plans over before Thursday","Follow up on the sister's interest in a place nearby"],"requirements":[{"text":"A 2-bed near the marina","requirement_raw":"looking for a 2-bed near the marina","stated_on":null,"confidence":"high"},{"text":"To move in before the summer","requirement_raw":"wants to move in before the summer","stated_on":null,"confidence":"high"},{"text":"A studio for her son","requirement_raw":"after a studio for her son","stated_on":null,"confidence":"high"},{"text":"Two units","requirement_raw":"if the budget clears she'd take two units","stated_on":null,"confidence":"low"}],"meeting":null}

Note: the marina 2-bed and the move-in timing are stated NEEDS → requirements, kept verbatim in requirement_raw. The do-vs-find line: "looking for a 2-bed near the marina" is something she asked us to FIND → a requirement, but "wants the floor plans sent over before Thursday" is something she asked us to DO → a next step, NOT a requirement, even though both are phrased as wants. The actor line (who is doing the looking): "a studio for her son" is still HER own need — she is the one looking, on his behalf → a requirement at high confidence (who is looking, not who benefits); but "her sister is looking for a place nearby" is a need she is REPORTING for someone else → a next step (a referral), NOT a requirement. The high service charges are a COMPLAINT about a past option → a concern, NOT a requirement. The two-units line is conditional ("if the budget clears") → captured at confidence "low". On stated_on: for a need stated in the current note you MUST set stated_on to TODAY'S DATE given below — it is printed as null in this static example only because the example carries no injected date (the same reason due_date reads null for "this Friday" in the examples above); resolve it to today's date in real output. Emit null only when the note attributes the need to an earlier, undated time.

### Example O - the client is a named person (appears in people, role unknown unless stated)

Input:
"Quick call with Omar Al Mansouri. He wants the revised quote by Thursday - said he'll take it to their board for approval."
